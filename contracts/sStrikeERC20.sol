...
contract sStrike is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Index", "sStrike", 9) ERC20Permit() {
    ...
    /**
        @notice increases sStrike supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sStrike
